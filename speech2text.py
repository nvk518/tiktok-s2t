...
def download_tiktok(url="https://tiktok-downloader-download-tiktok-videos-without-watermark.p.rapidapi.com/vid/index"):
    querystring = {"url":"https://www.tiktok.com/@_product_finder/video/7336640884626296069"}
...
def update_sheet(locations):
    ...
    credentials = service_account.Credentials.from_service_account_file(SHEETS_SERVICE_ACCOUNT_FILE)
